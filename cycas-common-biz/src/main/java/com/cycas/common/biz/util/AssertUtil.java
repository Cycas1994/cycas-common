package com.cycas.common.biz.util;
...
public class AssertUtil {
    ...
    public static void isTrue(boolean expression, String message, Object... values) {
        if (!expression) {
            throw new BizException(String.format(message, values));
        }
    }

    public static void isTrue(boolean expression, ICode code) {
        if (!expression) {
    ...
    public static void notNull(@Nullable Object object, ICode code) {
        if (object == null) {
            throw new BizException(code.getMessage());
        }
    }
